...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" runat="server">
    ...
    <section>
        ...
        <div class="carousel slide" id="gallery-carousel" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active">
                    <img src="Assets/images/11.jpg" alt="Slider image">
                    <div class="carousel-caption caption">Game Calculator </div>
                </div>
                <div class="item">
                    <img src="Assets/images/44.jpg" alt="Slider image">
                    <div class="carousel-caption h2">All Fields are
                        <br />
                        Required</div>
                </div>
                <div class="item">
                    <img src="Assets/images/77.jpg" alt="Slider image">
                    <div class="carousel-caption h2">No ties, one team
                        <br />
                        shoud Win</div>
                </div>
            </div>
        ...
        <!-- end carousel -->
    </section><!--Carausel Refered From Bootstrap Website-->
    ...
    <div class="row info-panel main">
        ...
        <div class="jumbotron col-lg-3 well">
            ...
            <div>
                ...
                <asp:RangeValidator ID="RangeValidatorSpectator1" ControlToValidate="txtSpec1" CssClass="text-danger" Display="Dynamic" MaximumValue="9999" MinimumValue="0" runat="server" Type="Integer" ErrorMessage="Spectator should be be greater than 0"></asp:RangeValidator>
            </div>
        </div>
        ...
        <div class="jumbotron col-lg-3 well">
            ...
            <div>
                ...
                <asp:RangeValidator ID="RangeValidatorSpectator2" ControlToValidate="txtSpectator2" CssClass="text-danger" Display="Dynamic" MaximumValue="9999" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Spectator should be greater than 0"></asp:RangeValidator>
            </div>
        </div>
        ...
        <div class="jumbotron col-lg-3 well">
            ...
            <div>
                ...
                <asp:RangeValidator ID="RangeValidatorSpectator3" ControlToValidate="txtSpectator3" CssClass="text-danger" Display="Dynamic" MaximumValue="9999" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Spectator should be greater than 0"></asp:RangeValidator>
            </div>
        </div>
        ...
        <div class="jumbotron col-lg-3 well">
            ...
            <div>
                ...
                <asp:RangeValidator ID="RangeValidatorSpectator4" ControlToValidate="txtSpectator4" CssClass="text-danger" Display="Dynamic" MaximumValue="9999" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Spectator should be greater than 0"></asp:RangeValidator>
            </div>
        </div>
